...
class DbInstanceData {
    ...
    getRecords(keys) {
        return new Promise((resolve, reject) => {
            ...
            console.debug(`Backing up DynamoDB with config: ${JSON.stringify(params)}`);
                ...
                return new Promise((rs, rj) => {
                    ...
                    dynamodb.scan(params, (err, data) => {
                        ...
                        data.Items.forEach((item) => {
                            ...
                            promises.push(this.dbRecord.backup([{
                        ...
                        Promise.all(promises)
                            .then(() => {
                                ...
                                console.debug(`Retrieved ${data.Items.length} records at segment ${params.Segment}. Total ${numberOfRecords} records processed.`);
